...
import numpy as np
from EmployeeApp.Basics import FaceRecognition
...
class VideoCamera(object):
	def __init__(self, vidpath=0):
		self.video = cv2.VideoCapture(vidpath)
		self.FaceRecognizer = FaceRecognition()
		self.encodings = self.FaceRecognizer.findEncodings()
	...
	def get_frame(self):
		...
		try:
			...
			image, info = FaceRecognition.RecognizeFace(FaceRecognizer,image,self.encodings)
		except:
			pass
		end = time.time()
		# print(end-start)
